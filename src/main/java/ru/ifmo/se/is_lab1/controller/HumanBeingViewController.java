...
import ru.ifmo.se.is_lab1.service.CarLookupService;
...
public class HumanBeingViewController {
    ...
    public HumanBeingViewController(HumanBeingService humanBeingService, CarLookupService carLookupService) {
    ...
    public String list(@RequestParam(name = "page") Optional<Integer> page,
        ...
        model.addAttribute("cars", carLookupService.findAll());
    ...
    public String editForm(@PathVariable("id") Long id, Model model) {
        if (!model.containsAttribute("human")) {
            ...
            if (dto.getCoordinates() != null) {
                form.setCoordinateX(dto.getCoordinates().getX());
                form.setCoordinateY(dto.getCoordinates().getY());
            }
            form.setRealHero(dto.isRealHero());
            form.setHasToothpick(dto.getHasToothpick());
            form.setImpactSpeed(dto.getImpactSpeed());
            form.setSoundtrackName(dto.getSoundtrackName());
            form.setMinutesOfWaiting(dto.getMinutesOfWaiting());
